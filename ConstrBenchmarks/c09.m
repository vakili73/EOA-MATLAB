function [InitFunction, CostFunction, FeasibleFunction] = c09
% c09 Function 
...
InitFunction = @c09Init;
CostFunction = @c09Cost;
FeasibleFunction = [];
return

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Population, OPTIONS] = c09Init(OPTIONS)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Population] = c09Cost(Population, OPTIONS)
