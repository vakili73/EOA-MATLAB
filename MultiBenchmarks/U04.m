function [InitFunction, CostFunction, FeasibleFunction] = U04
...
for pop = 1 : num
    ...
    temp1 = 0;
    for j = 3 : 2 : dim
        temp1 = temp1 + abs(y(j))/(1+exp(2*abs(y(j))));
    end
    J1 = 3 : 2 : dim;
    ...
    temp2 = 0;
    for j = 2 : 2 : dim
        temp2 = temp2 + abs(y(j))/(1+exp(2*abs(y(j))));
    end
    J2 = 2 : 2 : dim;
    Population(pop).cost(2) = 1 - (x(1)^2) + 2 * temp2 / length(J2);
end
return