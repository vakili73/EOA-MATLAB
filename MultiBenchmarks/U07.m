function [InitFunction, CostFunction, FeasibleFunction] = U07
...
for pop = 1 : num
    ...
    J1 = 3 : 2 : dim;
    Population(pop).cost(1) = (x(1)^(1/5)) + (2 * temp1 / length(J1));
    % f2
    temp2 = 0;
    for j = 2 : 2 : dim
        temp2 = temp2 + y(j)^2;
    ...
    J2 = 2 : 2 : dim;
    Population(pop).cost(2) = 1 - (x(1)^(1/5)) + (2 * temp2 / length(J2));
end
return